...
system([' flirt -in ' SUBJECT.ANATOMYdir 'T1_brain  -applyxfm -init ' SUBJECT.ASLdir prefix '_ASL_2T1_INV.mat -out ' SUBJECT.ANATOMYdir 'T1_2ASL_brain_' prefix ' -ref ' SUBJECT.ASLdir prefix '_T1fromM0 -paddingsize 0.0 -interp sinc'])
% register T1 brain mask to ASL space
system([' flirt -in ' SUBJECT.ANATOMYdir 'T1_brain_mask  -applyxfm -init ' SUBJECT.ASLdir prefix '_ASL_2T1_INV.mat -out ' SUBJECT.ANATOMYdir 'T1_2ASL_brain_mask_' prefix ' -ref ' SUBJECT.ASLdir prefix '_T1fromM0 -paddingsize 0.0 -interp nearestneighbour']) 
% register T1 CSF mask to ASL space
system([' flirt -in ' SUBJECT.ANATOMYdir 'T1_brain_seg_0  -applyxfm -init ' SUBJECT.ASLdir prefix '_ASL_2T1_INV.mat -out ' SUBJECT.ANATOMYdir 'T1_2ASL_CSF_' prefix ' -ref ' SUBJECT.ASLdir prefix '_T1fromM0 -paddingsize 0.0 -interp nearestneighbour' ])
% register T1 GM mask to ASL space
system([' flirt -in ' SUBJECT.ANATOMYdir 'T1_brain_seg_1  -applyxfm -init ' SUBJECT.ASLdir prefix '_ASL_2T1_INV.mat -out ' SUBJECT.ANATOMYdir 'T1_2ASL_GM_' prefix ' -ref ' SUBJECT.ASLdir prefix '_T1fromM0 -paddingsize 0.0 -interp nearestneighbour' ]) 
