...
%
function [nii, tmpName] = load_untouch_nii(filename, img_idx, dim5_idx, dim6_idx, dim7_idx, ...
    old_RGB, slice_idx)
...
[nii.hdr,nii.filetype,nii.fileprefix,nii.machine,tmpName] = load_nii_hdr(filename);
...
%
[nii.img,nii.hdr] = load_untouch_nii_img(nii.hdr,nii.filetype,nii.fileprefix, nii.machine,img_idx,dim5_idx,dim6_idx,dim7_idx,old_RGB,slice_idx);
%JCWS
