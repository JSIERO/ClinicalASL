...
import os
import json
from clinical_asl_pipeline import main_pipeline_vTR as main_pipeline 
...
def run_pipeline(inputdir, outputdir, inference_method=None, config_path=None):
    ...
    if config_path is None:
        config_path = os.path.join(os.path.dirname(__file__), 'clinical_asl_pipeline', 'config', 'config_vTR.json')
