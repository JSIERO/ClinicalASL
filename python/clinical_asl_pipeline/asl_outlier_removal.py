...
def asl_outlier_removal(subject, context_tag, usermask=None):
    ...
    if outlier_indices.size > 0:
        ...
        save_data_nifti(PLDall_or, append_or(context_data['PLDall_controllabel_path']), nifti_template_path,  1, None, context_data, TR)
        save_data_nifti(PLD2tolast_or,append_or(context_data['PLD2tolast_controllabel_path']), nifti_template_path,  1, None, context_data, TR)        
        save_data_nifti(PLD1to2_or, append_or(context_data['PLD1to2_controllabel_path']), nifti_template_path, 1, None,  context_data, TR)   
