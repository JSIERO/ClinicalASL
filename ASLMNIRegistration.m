...
system(['flirt -in ' SUBJECT.ASLdir prefix '_T1fromM0 -out ' SUBJECT.ASLdir prefix '_T1fromM0ASL_2MNI -ref ' SUBJECT.MNIdir 'MNI_T1_2mm_brain -omat ' SUBJECT.ASLdir prefix '_ASL_2MNI.mat -cost corratio -dof 12 -interp trilinear'])
