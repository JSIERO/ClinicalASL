...
eval(['!oxford_asl -i ' locationASLlabelcontrolPLDNIFTI ' -c ' locationM0 ' -m ' locationMask ' -o ' outputmap ' ' locationBASILinfostring artoffstring ' --bolus=' tau ' --slicedt=' slicetime ' --t1=' T1t ' --t1b=' T1b ' --t1t=' T1t ' --plds=' PLDstring ' --tr=' TR_M0 ' --alpha=' alpha ' --iaf=ct --ibf=tis --casl --fixbolus --cmethod voxel --cgain 1.00']);
