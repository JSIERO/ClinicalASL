...
SaveDataNII(SUBJECT.preACZ.AAT_smth, fullfile(SUBJECT.ASLdir, 'preACZ_AAT_smth'), SUBJECT.dummyfilenameSaveNII, 1, [], SUBJECT.TR);
SaveDataNII(SUBJECT.postACZ.AAT_smth, fullfile(SUBJECT.ASLdir, 'postACZ_AAT_smth'), SUBJECT.dummyfilenameSaveNII, 1, [], SUBJECT.TR);
SaveDataNII(SUBJECT.postACZ.AAT_2preACZ_smth, fullfile(SUBJECT.ASLdir, 'postACZ_AAT_2preACZ_smth'), SUBJECT.dummyfilenameSaveNII, 1, [], SUBJECT.TR);
