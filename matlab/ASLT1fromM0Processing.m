function SUBJECT = ASLT1fromM0Processing(SUBJECT, prefix, fast)
...
if strcmp(fast, 'fast')
    % skip the M0_forQCBF generation
else
...
if strcmp(fast, 'fast')
    % skip the tissue segmentation for M0_fromT1
else
    % tissue segment T1fromM0 using FSL FAST and load into SUBJECT struct
